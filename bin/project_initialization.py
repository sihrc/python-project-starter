...
if __name__ == "__main__":
    ...
    parser.add_argument("--email", help="Email for contacting author about project", required=True)
    parser.add_argument("--package", help="Name for the this python project", required=True)
    parser.add_argument("--description", help="Description for this python project", required=True)
